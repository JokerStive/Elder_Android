...
public class CustomRatingBar extends LinearLayout {
    ...
    public CustomRatingBar(Context context, AttributeSet attrs) {
        ...
        countNum = typedArray.getInt(R.styleable.customRatingBar_starCount, 5);
        countSelected = typedArray.getInt(R.styleable.customRatingBar_countSelected, 0);
        canEdit = typedArray.getBoolean(R.styleable.customRatingBar_canEdit, false);
        differentSize = typedArray.getBoolean(R.styleable.customRatingBar_differentSize, false);
        widthAndHeight = typedArray.getDimension(
                R.styleable.customRatingBar_widthAndHeight,
                UIUtils.dp2px(context, 0));
        dividerWidth = typedArray.getDimension(
                R.styleable.customRatingBar_dividerWidth,
                UIUtils.dp2px(context, 0));
        stateResId = typedArray.getResourceId(
                R.styleable.customRatingBar_stateResId, -1);
        initView();
    }
    ...
    private void initView() {
        ...
        for (int i = 0; i < countNum; i++) {
            ...
            if (stateResId == -1) {
                stateResId = R.drawable.selector_ratingbar;
            }
