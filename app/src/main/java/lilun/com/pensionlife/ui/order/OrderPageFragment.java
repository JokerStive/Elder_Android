...
//            filter =  "{\"where\":{\"and\":[{\"creatorId\":\"9183a520-8322-11e7-8053-8988faaa07d2\"},{\"status\":{\"inq\":[\"done\",\"assigned\"]}}]},\"limit\":\"20\",\"skip\":\"0\",\"limit\":\"10\",\"skip\":\"0\"}";
            filter = "  {\"where\":{\"and\":[{\"creatorId\":\"" + User.getUserId() + "\"},{\"status\":{\"inq\":[\"done\",\"assessed\"]}}]}}";
        } else if (mStatus.equals("assigned")) {
            filter = "  {\"where\":{\"and\":[{\"creatorId\":\"" + User.getUserId() + "\"},{\"status\":{\"inq\":[\"delay\",\"assigned\"]}}]}}";
        } else {
            filter = "  {\"where\":{\"and\":[{\"creatorId\":\"" + User.getUserId() + "\"},{\"status\":\"" + mStatus + "\"}]}}";
        }
