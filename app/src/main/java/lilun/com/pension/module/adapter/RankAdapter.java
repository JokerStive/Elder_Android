...
public class RankAdapter extends QuickAdapter<Rank> {
    ...
    protected void convert(BaseViewHolder helper, Rank rank) {
        ...
        helper.setText(R.id.tv_product_name, rank.getCreatorName())
        ...
        ImageLoaderUtil.instance().loadImage(IconUrl.moduleIconUrl(IconUrl.Accounts,User.getUserId(),null),R.drawable.icon_def,helper.getView(R.id.iv_icon));
    }
